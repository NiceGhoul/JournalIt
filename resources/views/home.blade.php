...
<div class="bg-customDark text-white">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <div class="bg-customDark border border-gray-700 rounded-lg p-3 w-full h-auto min-h-72 lg:w-60 relative transition-all duration-200 ease-in-out hover:shadow-custom hover:-translate-x-1 hover:-translate-y-1 hover:cursor-pointer" style="box-shadow: none;">
                <a href="{{ route('ToDoList') }}">
                <div class="flex justify-between">
                    <span class="text-2xl font-bold mb-2">To do List</span>
                    <img src="{{ $todo->logo }}" alt="" style="width:40px; height:40px; border-radius:100%">
                </div>
                ...
                <div class="progress mb-3 bg-customDark mt-2 border border-b-2" style="height: 20px;">
                    <div class="progress-bar bg-cardHome" role="progressbar" style="width: {{ $progressPercentage }}%;"
                ...
                <button class="bg-cardHome hover:bg-pink-600 hover:text-white text-cardHomeText text-sm font-semibold py-1 px-4 rounded absolute bottom-2 right-2">
                    Get done
                </button>
                </a>
            </div>
